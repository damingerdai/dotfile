...
local tStatus, tTerminal =  pcall(require, "toggleterm.terminal");
if not tStatus then 
  vim.notfiy("没有找到 toggleterm terminal")
end

local Terminal = tTerminal.Terminal;
